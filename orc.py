...
class Orc:
    def __init__(self, x, y, get_player_position, on_player_body_entered):
        ...
        self.enemy_hurt = self._sprite_loader(path="assets/enemy/orc/hurt/hurt_0.png",
                                              size=self.enemy_size)
        self.enemy_death = self._sprite_loader(path="assets/death/death",
                                               length=5,
                                               size=(128, 128))
        self.hurt_sound = pygame.mixer.Sound("assets/audio/orc_hurt_sound.wav")
        self.moving = True
        self.death = False
        self.hurt = False
    ...
    def is_bullet_hit(self):
        ...
        self.hurt = True
        self.hit_count += 1
        print(f"Orc hit! Current HP: {self.hit_count}")
